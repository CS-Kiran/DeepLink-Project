...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <title></title>
    <h1 style="color : #613fe5; font-weight:600; font-size: 50px; padding:15px; font-family:'Courier New', Courier, monospace;">
	<center>Upcoming Projects</center></h1>
...
<?php
	...
	$query="SELECT pid, pname,dept_name,pstatus,psdate,pedate,plocation,platitude,plongitude FROM project_details WHERE pstatus = 'Upcoming' ORDER BY pstatus ASC";
...
?>
<br><br>
<a href="./ONGOING.php" style="position:relative; padding:15px; color:aqua; font-size: 18px;">Show Ongoing Projects</a>
